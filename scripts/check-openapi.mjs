...
export function contractText(document) {
  if (
    ...
    throw new Error('Missing or empty OpenAPI document');
...
export function assertContract(current, saved) {
  if (contractText(current) !== contractText(saved)) {
    throw new Error(
      'OpenAPI drift: review the generated API contract and run pnpm contract:update after an intentional change.'
    );
  }
}
