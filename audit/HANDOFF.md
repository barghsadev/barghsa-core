...
Active **R01-invoice-deadlines-reminders**:10 saved PRs236–241,243–246; tasks `04-invoices-wallet-contracts.md#T-04.1.03.01` through `.04` and `T-04.1.04.01` through `.06`. Exact story/task requirements and all10 full PR descriptions read. First repair0e370f7 binds deadline reads/mutations to current session authority through commit;21 distinct API cases and quality checks pass. Staff form repaired atb6f46be:9 web cases,4 distinct production Chromium cases and42 budgets pass, with locale/theme, focus, timezone, step-up and response binding. Reminder rescheduling repaired at7fe8924:71 worker cases and21 API cases pass, with final5 HTTP rollback checks. Sent history stays intact. Historical data reconciliation and already queued delivery remain separate. Reminder-toggle authority repaired at9a954fa with19 API cases. Customer public reasons repaired at0566eea with29 API,9 web,4 browser cases and42 budgets. Reminder save confirmation repaired atdf34b30 with22 component cases. Next: build the missing due-period admin setting flow, then finish workflow review. Batch remains open. Inspect defaults, permission/reason override, customer-visible reason, issue scheduling, offset/timezone/preferences, outbox, idempotency and terminal-state cancellation. Reuse21 overdue worker and state/creation/receipt checks. Actual delivery remains linked to R02. Review each confirmed repair, then consolidate once.

## Counts and preserved work

**110 verified /25 partial /187 pending =322 claims.212 unresolved reviews are not a coding-effort estimate.** Saved PR reviews: **79 closed /16 open /206 not reviewed** of301.58 historical skips:3 verified/55 pending. GitHub inventory ends September3; no live refresh claimed.11 older evidence refreshes remain separately queued.1878 logs indexed.
