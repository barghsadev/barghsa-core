...
The electricity browsing, ordering, payment, review, tracking and journey-test batches are on `main`, followed by [quantity increase intake and review](batches/2026-09-23-electricity-increase-intake.md) at `16e5b534`, [approval/amendment](batches/2026-09-23-electricity-increase-approval.md) at `fad30fe6`, [signature, adjustment payment and activation](batches/2026-09-23-electricity-increase-activation.md) at `b80265b3`, [expiry reconciliation](batches/2026-09-23-electricity-increase-expiry.md) at `845a65b9`, and [staff price adjustments](batches/2026-09-23-electricity-price-adjustments.md) at `d5acf060`. The [power-saving catalogue batch](batches/2026-09-23-saving-catalogue.md) connects plans, compatible hardware and versioned agreements to customer browsing. The current [power-saving order intake batch](batches/2026-09-23-saving-order-intake.md) adds customer checkout and atomic order/contract/invoice creation. Next are saving staff review, fulfillment and cancellation. The task queue is canonical for order and requirements, not a completion ledger; the older September 20–21 status below is historical context. The user requested manual batches pushed directly to `main`, without PRs or restarting the scheduler.
