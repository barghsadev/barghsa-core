...
PR [#312](https://github.com/barghsadev/barghsa-core/pull/312) is merged at `4eea6d19` after independent approval and all five active checks passed. The active [durable refund retry batch](batches/2026-09-20-refund-retries.md) is based on that merge. Shared credit posting is implemented and tested; durable failure scheduling, worker registration and remaining lifecycle criteria are still in progress.
