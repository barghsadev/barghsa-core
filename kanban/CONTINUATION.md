...
The external bank refund batch is implemented locally on `codex/external-refund-batch` with 35 passing refund tests and 36 passing refund/template checks. It is queued for rebase and independent review after the invoice-history coverage follow-up; it is not yet merged or accepted.
