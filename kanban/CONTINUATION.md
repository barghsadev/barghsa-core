...
The external bank refund batch is implemented locally on `codex/external-refund-batch` with 32 passing refund tests. It is queued for rebase and independent review after the isolated HTTP fixture maintenance batch; it is not yet merged or accepted.
