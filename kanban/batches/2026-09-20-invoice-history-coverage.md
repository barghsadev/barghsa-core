...
PR [#311](https://github.com/barghsadev/barghsa-core/pull/311) merged at `25a85079975c9a123aa983bf5029c30b6893e6e7`. Final HEAD `abc27841b009561d178c736dc103bc02b828baee` received [independent approval](https://github.com/barghsadev/barghsa-core/pull/311#issuecomment-5750114942) and all five active checks passed in [CI](https://github.com/barghsadev/barghsa-core/actions/runs/35513669564). The final test mock syntax also passes the pinned Semgrep parser without exclusions. PR fast mode does not measure coverage; the explicit original-source local gate above supplies that evidence.
