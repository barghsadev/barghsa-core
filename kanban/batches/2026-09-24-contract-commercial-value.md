...
This adds an explicit value for authored versions. Existing system-generated contract versions remain unstated until their producers supply a defensible full-contract value; no amount is inferred from a deposit or first invoice. A dedicated contract number and signed legal-party snapshot remain open.
