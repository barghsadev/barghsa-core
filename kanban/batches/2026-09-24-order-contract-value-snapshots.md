...
Historical versions are not rewritten. Solar construction contracts remain unstated because their current invoice lines do not prove a full contract value. A dedicated contract number and signed legal-party snapshot are separate work.
