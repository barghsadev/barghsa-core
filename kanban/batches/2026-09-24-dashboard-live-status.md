...
Limit: the electricity and saving links open their full order lists; list-level pending filters are still absent. Do not treat that filtering acceptance detail as complete.
