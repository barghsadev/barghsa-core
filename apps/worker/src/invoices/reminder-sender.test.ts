...
function sendOptions(db: FakeDb, overrides: Record<string, unknown> = {}) {
...
function scheduleRow(extras: Partial<{ id: string; channel: string; offset: number }> = {}) {
  return {
...
function defaultHandler(
  ...
  lockedRows: ReturnType<typeof scheduleRow>[] = [
    scheduleRow(),
    scheduleRow({ id: ROW_EMAIL, channel: 'email' }),
  ],
