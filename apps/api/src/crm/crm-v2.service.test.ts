...
// Profile edits, contact isolation, validation and audit rollback/concurrency
// are exercised through the production HTTP application in crm-contact-http.integration.test.ts.

// Verification transactions and state cases are exercised against PostgreSQL
// in crm-verification.integration.test.ts.
