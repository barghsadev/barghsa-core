...
export const en = {
  ...
  openLinkedSavingOrder: 'Open saving order',
  ...
  payInitialInvoice: 'Pay the initial invoice',
  initialPaymentUnderReview: 'Initial invoice payment is being reviewed.',
  ...
  linkedOrderStatus: 'Electricity order status',
  acceptedParty: 'Party at acceptance',
  legalIdentifier: 'Legal national identifier',
  nationalIdentifier: 'National ID',
  registrationNumber: 'Registration number',
  account: 'Account',
  apply: 'Apply filters',
  invalidProfile: 'Enter a valid profile reference.',
  invalidContractNumber: 'Enter a valid contract number.',
...
export const fa: Record<keyof typeof en, string> = {
  ...
  openLinkedSavingOrder: 'مشاهده سفارش پس‌انداز',
  ...
  payInitialInvoice: 'پرداخت صورتحساب اولیه',
  initialPaymentUnderReview: 'پرداخت صورتحساب اولیه در حال بررسی است.',
  ...
  contractReference: 'شناسه قرارداد',
  contractNumber: 'شماره قرارداد',
  linkedOrderStatus: 'وضعیت سفارش برق',
  acceptedParty: 'طرف قرارداد هنگام پذیرش',
  legalIdentifier: 'شناسه ملی شخص حقوقی',
  nationalIdentifier: 'کد ملی',
  registrationNumber: 'شماره ثبت',
  account: 'حساب',
  apply: 'اعمال فیلترها',
  invalidProfile: 'شناسه معتبر پروفایل را وارد کنید.',
  invalidContractNumber: 'شماره قرارداد معتبر را وارد کنید.',
