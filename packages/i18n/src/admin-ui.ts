...
export const fa: I18nDictionary = {
  ...
  'admin.invoiceReceipts.historyTitle': 'سابقه رسیدهای بررسی‌شده',
  'admin.invoiceReceipts.historyState': 'نتیجه بررسی',
  'admin.invoiceReceipts.historyAll': 'همه نتایج',
  'admin.invoiceReceipts.historyApply': 'اعمال فیلتر',
  'admin.invoiceReceipts.historyInvalidInvoice': 'شناسه صورتحساب معتبر نیست.',
  'admin.invoiceReceipts.historyError': 'دریافت سابقه رسیدها ممکن نشد.',
  'admin.invoiceReceipts.historyEmpty': 'رسیدی با این فیلتر پیدا نشد.',
  'admin.invoiceReceipts.historyPages': 'صفحات سابقه رسیدها',
  'admin.invoiceReceipts.historyPrevious': 'صفحه قبل',
  'admin.invoiceReceipts.historyNext': 'صفحه بعد',
  'admin.invoiceReceipts.historyRejectionReason': 'دلیل رد',
  'admin.invoiceReceipts.historyAttachmentUnavailable': 'فایل رسید در دسترس نیست.',
  ...
  'admin.electricityOrders.views': 'نمای سفارش‌های برق',
  'admin.electricityOrders.reviewView': 'در انتظار بررسی',
  'admin.electricityOrders.conversationView': 'گفت‌وگوهای سفارش',
  'admin.electricityOrders.emptyConversations': 'هنوز گفت‌وگویی برای سفارش‌های برق ثبت نشده است.',
  ...
  'admin.electricityOrders.more': 'سفارش‌های بیشتر',
  'admin.electricityOrders.loading': 'در حال دریافت صف…',
  'admin.electricityOrders.loadingDetail': 'در حال دریافت جزئیات…',
  'admin.electricityOrders.lookupOrderId': 'شناسه سفارش برق',
  'admin.electricityOrders.lookup': 'یافتن سفارش',
  'admin.electricityOrders.invalidOrderId': 'شناسه سفارش معتبر وارد کنید.',
  'admin.electricityOrders.detailError': 'جزئیات سفارش پیدا نشد یا در دسترس نیست.',
  'admin.electricityOrders.retryDetail': 'تلاش دوباره',
  'admin.electricityOrders.error': 'دریافت سفارش‌ها انجام نشد. دوباره تازه‌سازی کنید.',
  'admin.electricityOrders.forbidden': 'اجازه بررسی سفارش‌های برق را ندارید.',
  'admin.electricityOrders.empty': 'سفارشی در انتظار بررسی نیست.',
  'admin.electricityOrders.queue': 'صف بررسی سفارش‌های برق',
  'admin.electricityOrders.detail': 'جزئیات سفارش',
  'admin.electricityOrders.hours': 'ساعت',
  'admin.electricityOrders.priority.normal': 'عادی',
  'admin.electricityOrders.priority.high': 'بالا',
  'admin.electricityOrders.priority.urgent': 'فوری',
  'admin.electricityOrders.customer': 'مشتری',
  'admin.electricityOrders.submitted': 'زمان ثبت',
  'admin.electricityOrders.period': 'بازه تحویل',
  'admin.electricityOrders.quantity': 'مقدار',
  'admin.electricityOrders.price': 'مبلغ کل',
  'admin.electricityOrders.paid': 'پرداخت‌شده',
  'admin.electricityOrders.financial': 'وضعیت مالی',
  'admin.electricityOrders.commercial': 'وضعیت سفارش',
  'admin.electricityOrders.address': 'نشانی تحویل',
  'admin.electricityOrders.snapshots': 'جزئیات ثبت‌شده قیمت و قرارداد',
  'admin.electricityOrders.pricingSnapshot': 'قیمت و محصولات',
  'admin.electricityOrders.products': 'محصولات سفارش',
  'admin.electricityOrders.product': 'محصول',
  'admin.electricityOrders.product.thermal': 'برق حرارتی',
  'admin.electricityOrders.product.green': 'برق سبز',
  'admin.electricityOrders.product.free_market': 'برق بازار آزاد',
  'admin.electricityOrders.product.energy_saving': 'صرفه‌جویی انرژی',
  'admin.electricityOrders.unitPrice': 'قیمت واحد',
  'admin.electricityOrders.subtotal': 'جمع پیش از تخفیف و مالیات',
  'admin.electricityOrders.discount': 'تخفیف',
  'admin.electricityOrders.lineTotal': 'خالص پیش از مالیات',
  'admin.electricityOrders.vat': 'مالیات بر ارزش افزوده',
  ...
  'admin.electricityOrders.revision.field': 'مورد',
  'admin.electricityOrders.revision.previous': 'قبلی',
  'admin.electricityOrders.revision.current': 'جدید',
  'admin.electricityOrders.revision.invoice': 'فاکتور',
  'admin.electricityOrders.openInvoice': 'نمایش فاکتور',
  'admin.electricityOrders.contract': 'قرارداد',
  'admin.electricityOrders.openContract': 'نمایش قرارداد',
  'admin.electricityOrders.timeline': 'روند سفارش',
  'admin.electricityOrders.emptyTimeline': 'هنوز رویدادی برای سفارش ثبت نشده است.',
  'admin.electricityOrders.reason': 'دلیل برای درخواست اصلاح یا رد',
  'admin.electricityOrders.approve': 'تأیید سفارش',
  'admin.electricityOrders.request-changes': 'درخواست اصلاح',
  'admin.electricityOrders.reject': 'رد سفارش',
  'admin.electricityOrders.confirm': 'این تصمیم ثبت شود و به مشتری اطلاع داده شود؟',
  'admin.electricityOrders.conflict': 'سفارش تغییر کرده است. صف را تازه‌سازی کنید.',
  'admin.electricityOrders.financial.unpaid': 'پرداخت‌نشده',
  'admin.electricityOrders.financial.payment_under_review': 'پرداخت در حال بررسی',
  'admin.electricityOrders.financial.partially_funded': 'بخشی پرداخت‌شده',
  'admin.electricityOrders.financial.paid': 'پرداخت‌شده',
  'admin.electricityOrders.financial.refund_pending': 'بازپرداخت در انتظار',
  'admin.electricityOrders.financial.partially_refunded': 'بخشی بازپرداخت‌شده',
  'admin.electricityOrders.financial.refunded': 'بازپرداخت‌شده',
  'admin.electricityOrders.commercial.awaiting_staff_review': 'در انتظار بررسی',
  'admin.electricityOrders.commercial.changes_requested': 'نیازمند اصلاح',
  'admin.electricityOrders.commercial.approved': 'تأییدشده',
  'admin.electricityOrders.commercial.rejected': 'ردشده',
  ...
  'admin.agents.testChat.title': 'گفت‌وگوی آزمایشی عامل',
  'admin.agents.testChat.newConversation': 'گفت‌وگوی جدید',
  'admin.agents.testChat.isolated': 'این آزمایش از گفت‌وگوهای کاربران جدا است.',
  'admin.agents.testChat.agent': 'عامل',
  'admin.agents.testChat.chooseAgent': 'عامل فعال را انتخاب کنید',
  'admin.agents.testChat.empty': 'پیامی هنوز ارسال نشده است.',
  'admin.agents.testChat.metadata': 'جزئیات پاسخ',
  'admin.agents.testChat.tokens': 'توکن‌های ورودی / خروجی',
  ...
  'admin.agents.testChat.rateLimited': 'سقف ۱۰ درخواست در دقیقه پر شده است. کمی بعد تلاش کنید.',
  'admin.agents.testChat.policyBlocked': 'این پیام با سیاست‌های عامل مجاز نیست.',
  'admin.agents.testChat.unavailable': 'عامل یا پایگاه دانش آماده نیست. تنظیمات را بررسی کنید.',
  'admin.agents.testChat.retry': 'تلاش دوباره',
  'admin.agents.testChat.message': 'پیام آزمایشی',
  'admin.agents.testChat.sending': 'در حال ارسال…',
  'admin.agents.testChat.send': 'ارسال',
  ...
  'admin.agents.systemPrompt': 'دستورالعمل سیستم',
  'admin.agents.temperature': 'دما',
  'admin.agents.maxTokens': 'حداکثر توکن',
  'admin.agents.modelDefault': 'پیش‌فرض مدل',
  'admin.agents.linkMode': 'حالت پایگاه دانش',
  'admin.agents.anyKb': 'استفاده از هر پایگاه مرتبط',
  'admin.agents.allKbs': 'استفاده از همه پایگاه‌های مرتبط',
  'admin.agents.assignedToSlots': 'ابتدا این عامل را از همه جایگاه‌ها بردارید.',
  ...
  'admin.agents.confirmDelete':
    'این عامل و پیوندهای آن حذف شود؟ عامل‌های تخصیص‌یافته به جایگاه قابل حذف نیستند.',
  ...
  'admin.kb.newDocument': 'سند جدید',
  'admin.kb.upload': 'بارگذاری سند',
  'admin.kb.uploading': 'در حال بارگذاری و بررسی سند…',
  'admin.kb.attachUploaded': 'پیوست سند بارگذاری‌شده',
  'admin.kb.uploaded': 'سند ذخیره شد. پیوست آن را تأیید کنید.',
  'admin.kb.uploadHelp': 'PDF، Word، Excel، TXT یا CSV. محدودیت‌های بارگذاری سازمان اعمال می‌شود.',
  'admin.kb.uploadError':
    'بارگذاری یا تأیید ذخیره انجام نشد. قالب و اندازه فایل را بررسی کنید. پیش از تلاش دوباره، فایل‌های موجود را جستجو کنید.',
  'admin.kb.pickerHelp':
  ...
  'admin.kb.sourceType': 'نوع منبع',
  'admin.kb.sourceDocument': 'سند بارگذاری‌شده',
  'admin.kb.sourceUrl': 'صفحه وب',
  'admin.kb.sourceApi': 'نشانی API',
  'admin.kb.sourceAddress': 'نشانی امن منبع (HTTPS)',
  'admin.kb.sourceUrlsHelp':
    'برای هر صفحه یک نشانی HTTPS در خط جداگانه وارد کنید (حداکثر ۲۰ صفحه).',
  'admin.kb.chunkSize': 'اندازه بخش (نویسه)',
  'admin.kb.chunkOverlap': 'همپوشانی بخش‌ها',
  'admin.kb.embeddingModel': 'مدل بردارسازی',
  'admin.kb.contentState': 'وضعیت محتوا',
  'admin.kb.stateempty': 'بدون محتوا',
  'admin.kb.stateprocessing': 'در حال پردازش',
  'admin.kb.stateready': 'آماده',
  'admin.kb.stateerror': 'خطا',
  'admin.kb.enabled': 'فعال',
  'admin.kb.disabled': 'غیرفعال',
  'admin.kb.enable': 'فعال‌سازی',
  'admin.kb.disable': 'غیرفعال‌سازی',
  'admin.kb.testQuery': 'آزمایش جستجو',
  'admin.kb.runQuery': 'جستجو',
  'admin.kb.queryLoading': 'در حال جستجو…',
  'admin.kb.queryError': 'جستجو انجام نشد. دوباره تلاش کنید.',
  'admin.kb.queryResults': 'نتایج جستجوی پایگاه دانش',
  'admin.kb.relevance': 'ارتباط',
  'admin.kb.noMatches': 'نتیجه‌ای یافت نشد.',
  'admin.kb.processingError': 'خطای پردازش',
  'admin.kb.reprocess': 'پردازش دوباره',
  'admin.kb.confirmReprocess': 'محتوای نمایه‌شده فعلی حذف و پردازش دوباره آغاز شود؟',
  'admin.kb.errorProviderMissing': 'ارائه‌دهنده بردارسازی تنظیم نشده است.',
  'admin.kb.errorModelMissing': 'مدل بردارسازی را انتخاب کنید.',
  'admin.kb.errorSourceEmpty': 'منبعی برای پردازش وجود ندارد.',
  'admin.kb.errorSourceUnavailable': 'فایل منبع در دسترس نیست.',
  'admin.kb.errorUnsupportedFile': 'نوع فایل برای پردازش پشتیبانی نمی‌شود.',
  'admin.kb.errorGeneric': 'پردازش انجام نشد. تنظیمات منبع را بررسی و دوباره تلاش کنید.',
  'admin.kb.save': 'ذخیره',
  'admin.kb.cancel': 'لغو',
  ...
  'admin.aiModels.enable': 'فعال‌سازی',
  'admin.aiModels.disable': 'غیرفعال‌سازی',
  'admin.aiModels.enabled': 'فعال',
  'admin.aiModels.disabled': 'غیرفعال',
  'admin.aiModels.maxTokens': 'حداکثر توکن پاسخ',
  'admin.aiModels.temperature': 'دمای پاسخ',
  'admin.aiModels.latency': 'زمان پاسخ آزمایش',
  'admin.aiModels.testRequired': 'پیش از فعال‌سازی، اتصال مدل را با موفقیت آزمایش کنید.',
  'admin.aiModels.confirmToggle': 'وضعیت استفاده از این مدل تغییر کند؟',
  'admin.aiModels.inUseAgents': 'این مدل در عامل‌های زیر استفاده می‌شود: {agents}',
  ...
  'admin.jobs.type.contract_completion': 'تکمیل دوره قرارداد',
  'admin.jobs.type.contract_activation': 'فعال‌سازی قرارداد',
  'admin.jobs.type.refund_retry': 'تلاش مجدد بازپرداخت کیف پول',
  ...
  'admin.invoices.ledger.title': 'دفتر فاکتورها',
  'admin.invoices.ledger.description':
    'فاکتورها را پیدا کنید و ریز اقلام و پرداخت‌ها را بررسی کنید.',
  'admin.invoices.ledger.state': 'وضعیت',
  'admin.invoices.ledger.allStates': 'همه وضعیت‌ها',
  'admin.invoices.ledger.searchId': 'شناسه فاکتور (اختیاری)',
  'admin.invoices.ledger.searchProfileId': 'شناسه مشتری (اختیاری)',
  'admin.invoices.ledger.searchOrderId': 'شناسه سفارش (اختیاری)',
  'admin.invoices.ledger.search': 'جستجو',
  'admin.invoices.ledger.invalidId': 'شناسه فاکتور معتبر نیست.',
  'admin.invoices.ledger.invalidProfileId': 'شناسه مشتری معتبر نیست.',
  'admin.invoices.ledger.invalidOrderId': 'شناسه سفارش معتبر نیست.',
  'admin.invoices.ledger.forbidden': 'اجازه مشاهده فاکتورها را ندارید.',
  'admin.invoices.ledger.error': 'بارگذاری فاکتورها ناموفق بود.',
  'admin.invoices.ledger.retry': 'تلاش دوباره',
  'admin.invoices.ledger.loading': 'در حال بارگذاری فاکتورها…',
  'admin.invoices.ledger.empty': 'فاکتوری پیدا نشد.',
  'admin.invoices.ledger.invoice': 'شناسه فاکتور',
  'admin.invoices.ledger.type': 'نوع',
  'admin.invoices.ledger.type.auto': 'خودکار',
  'admin.invoices.ledger.type.manual': 'دستی',
  'admin.invoices.ledger.order': 'شناسه سفارش',
  'admin.invoices.ledger.amount': 'مبلغ',
  'admin.invoices.ledger.paid': 'پرداخت‌شده',
  'admin.invoices.ledger.due': 'سررسید',
  'admin.invoices.ledger.period': 'دوره تأمین برق',
  'admin.invoices.ledger.unknown': 'نامشخص',
  'admin.invoices.ledger.more': 'نمایش بیشتر',
  'admin.invoices.ledger.detail': 'جزئیات فاکتور',
  'admin.invoices.ledger.close': 'بستن',
  'admin.invoices.ledger.loadingDetail': 'در حال بارگذاری جزئیات…',
  'admin.invoices.ledger.detailError': 'بارگذاری جزئیات ناموفق بود.',
  'admin.invoices.ledger.profile': 'شناسه مشتری',
  ...
  'admin.invoices.ledger.unitPrice': 'قیمت واحد',
  'admin.invoices.ledger.lineTotal': 'جمع قلم',
  'admin.invoices.ledger.vat': 'مالیات',
  'admin.invoices.ledger.vatTotal': 'جمع مالیات',
  'admin.invoices.ledger.activity': 'سابقه پرداخت',
  'admin.invoices.ledger.payment': 'پرداخت',
  'admin.invoices.ledger.receipt': 'رسید بانکی',
  'admin.invoices.ledger.openReceipt': 'نمایش تصویر رسید',
  'admin.invoices.ledger.refund': 'بازپرداخت',
  'admin.invoices.ledger.noActivity': 'هنوز پرداختی ثبت نشده است.',
...
export const en: I18nDictionary = {
  ...
  'admin.invoiceReceipts.historyTitle': 'Reviewed receipt history',
  'admin.invoiceReceipts.historyState': 'Review outcome',
  'admin.invoiceReceipts.historyAll': 'All outcomes',
  'admin.invoiceReceipts.historyApply': 'Apply filter',
  'admin.invoiceReceipts.historyInvalidInvoice': 'Enter a valid invoice ID.',
  'admin.invoiceReceipts.historyError': 'Could not load receipt history.',
  'admin.invoiceReceipts.historyEmpty': 'No receipts match these filters.',
  'admin.invoiceReceipts.historyPages': 'Receipt history pages',
  'admin.invoiceReceipts.historyPrevious': 'Previous page',
  'admin.invoiceReceipts.historyNext': 'Next page',
  'admin.invoiceReceipts.historyRejectionReason': 'Rejection reason',
  'admin.invoiceReceipts.historyAttachmentUnavailable': 'The receipt file is unavailable.',
  ...
  'admin.electricityOrders.views': 'Electricity order views',
  'admin.electricityOrders.reviewView': 'Awaiting review',
  'admin.electricityOrders.conversationView': 'Order conversations',
  'admin.electricityOrders.emptyConversations': 'No electricity order conversations yet.',
  'admin.electricityOrders.description': 'Review pending orders by age and priority.',
  'admin.electricityOrders.refresh': 'Refresh',
  'admin.electricityOrders.more': 'More orders',
  'admin.electricityOrders.loading': 'Loading queue…',
  'admin.electricityOrders.loadingDetail': 'Loading detail…',
  'admin.electricityOrders.lookupOrderId': 'Electricity order ID',
  'admin.electricityOrders.lookup': 'Find order',
  'admin.electricityOrders.invalidOrderId': 'Enter a valid order ID.',
  'admin.electricityOrders.detailError': 'Order details were not found or are unavailable.',
  'admin.electricityOrders.retryDetail': 'Retry',
  'admin.electricityOrders.error': 'Could not load orders. Refresh to retry.',
  'admin.electricityOrders.forbidden': 'You cannot review electricity orders.',
  'admin.electricityOrders.empty': 'No orders await review.',
  'admin.electricityOrders.queue': 'Electricity order review queue',
  'admin.electricityOrders.detail': 'Order detail',
  'admin.electricityOrders.hours': 'hours',
  'admin.electricityOrders.priority.normal': 'Normal',
  'admin.electricityOrders.priority.high': 'High',
  'admin.electricityOrders.priority.urgent': 'Urgent',
  'admin.electricityOrders.customer': 'Customer',
  'admin.electricityOrders.submitted': 'Submitted',
  'admin.electricityOrders.period': 'Delivery period',
  'admin.electricityOrders.quantity': 'Quantity',
  'admin.electricityOrders.price': 'Total price',
  'admin.electricityOrders.paid': 'Paid',
  'admin.electricityOrders.financial': 'Financial status',
  'admin.electricityOrders.commercial': 'Order status',
  'admin.electricityOrders.address': 'Delivery address',
  'admin.electricityOrders.snapshots': 'Saved pricing and contract detail',
  'admin.electricityOrders.pricingSnapshot': 'Pricing and products',
  'admin.electricityOrders.products': 'Order products',
  'admin.electricityOrders.product': 'Product',
  'admin.electricityOrders.product.thermal': 'Thermal electricity',
  'admin.electricityOrders.product.green': 'Green electricity',
  'admin.electricityOrders.product.free_market': 'Free-market electricity',
  'admin.electricityOrders.product.energy_saving': 'Energy saving',
  'admin.electricityOrders.unitPrice': 'Unit price',
  'admin.electricityOrders.subtotal': 'Subtotal',
  'admin.electricityOrders.discount': 'Discount',
  'admin.electricityOrders.lineTotal': 'Net before VAT',
  'admin.electricityOrders.vat': 'VAT',
  ...
  'admin.electricityOrders.revision.field': 'Item',
  'admin.electricityOrders.revision.previous': 'Previous',
  'admin.electricityOrders.revision.current': 'Revised',
  'admin.electricityOrders.revision.invoice': 'Invoice',
  'admin.electricityOrders.openInvoice': 'Open invoice',
  'admin.electricityOrders.contract': 'Contract',
  'admin.electricityOrders.openContract': 'Open contract',
  'admin.electricityOrders.timeline': 'Order timeline',
  'admin.electricityOrders.emptyTimeline': 'No order activity recorded yet.',
  'admin.electricityOrders.reason': 'Reason for changes or rejection',
  'admin.electricityOrders.approve': 'Approve order',
  'admin.electricityOrders.request-changes': 'Request changes',
  'admin.electricityOrders.reject': 'Reject order',
  'admin.electricityOrders.confirm': 'Record this decision and notify the customer?',
  'admin.electricityOrders.conflict': 'The order changed. Refresh the queue.',
  'admin.electricityOrders.financial.unpaid': 'Unpaid',
  'admin.electricityOrders.financial.payment_under_review': 'Payment under review',
  'admin.electricityOrders.financial.partially_funded': 'Partially funded',
  'admin.electricityOrders.financial.paid': 'Paid',
  'admin.electricityOrders.financial.refund_pending': 'Refund pending',
  'admin.electricityOrders.financial.partially_refunded': 'Partially refunded',
  'admin.electricityOrders.financial.refunded': 'Refunded',
  'admin.electricityOrders.commercial.awaiting_staff_review': 'Awaiting staff review',
  'admin.electricityOrders.commercial.changes_requested': 'Changes requested',
  'admin.electricityOrders.commercial.approved': 'Approved',
  'admin.electricityOrders.commercial.rejected': 'Rejected',
  ...
  'admin.agents.testChat.title': 'Test an agent',
  'admin.agents.testChat.newConversation': 'New conversation',
  'admin.agents.testChat.isolated': 'This preview is separate from customer conversations.',
  'admin.agents.testChat.agent': 'Agent',
  'admin.agents.testChat.chooseAgent': 'Choose an enabled agent',
  'admin.agents.testChat.empty': 'No messages yet.',
  'admin.agents.testChat.metadata': 'Response details',
  'admin.agents.testChat.tokens': 'Input / output tokens',
  ...
  'admin.agents.testChat.rateLimited':
    'The 10 requests per minute limit is reached. Try again shortly.',
  'admin.agents.testChat.policyBlocked': 'This message is blocked by the agent policies.',
  'admin.agents.testChat.unavailable':
    'The agent or knowledge base is not ready. Check its settings.',
  'admin.agents.testChat.retry': 'Retry',
  'admin.agents.testChat.message': 'Test message',
  'admin.agents.testChat.sending': 'Sending…',
  'admin.agents.testChat.send': 'Send',
  ...
  'admin.agents.systemPrompt': 'System instructions',
  'admin.agents.temperature': 'Temperature',
  'admin.agents.maxTokens': 'Maximum tokens',
  'admin.agents.modelDefault': 'Model default',
  'admin.agents.linkMode': 'Knowledge-base mode',
  'admin.agents.anyKb': 'Use any linked KB',
  'admin.agents.allKbs': 'Use all linked KBs',
  'admin.agents.assignedToSlots': 'Unassign this agent from every slot first.',
  ...
  'admin.agents.confirmDelete':
    'Delete this agent and its links? Agents assigned to slots cannot be deleted.',
  ...
  'admin.kb.newDocument': 'New document',
  'admin.kb.upload': 'Upload document',
  'admin.kb.uploading': 'Uploading and verifying document…',
  'admin.kb.attachUploaded': 'Attach uploaded document',
  'admin.kb.uploaded': 'Document saved. Confirm its attachment.',
  'admin.kb.uploadHelp': 'PDF, Word, Excel, TXT or CSV. Your organization’s upload limits apply.',
  'admin.kb.uploadError':
    'Upload or save confirmation failed. Check the file format and size. Search existing uploads before retrying.',
  ...
  'admin.kb.sourceType': 'Source type',
  'admin.kb.sourceDocument': 'Uploaded document',
  'admin.kb.sourceUrl': 'Web page',
  'admin.kb.sourceApi': 'API endpoint',
  'admin.kb.sourceAddress': 'Secure source address (HTTPS)',
  'admin.kb.sourceUrlsHelp': 'Enter one HTTPS page per line (up to 20 pages).',
  'admin.kb.chunkSize': 'Chunk size (characters)',
  'admin.kb.chunkOverlap': 'Chunk overlap',
  'admin.kb.embeddingModel': 'Embedding model',
  'admin.kb.contentState': 'Content state',
  'admin.kb.stateempty': 'No content',
  'admin.kb.stateprocessing': 'Processing',
  'admin.kb.stateready': 'Ready',
  'admin.kb.stateerror': 'Error',
  'admin.kb.enabled': 'Enabled',
  'admin.kb.disabled': 'Disabled',
  'admin.kb.enable': 'Enable',
  'admin.kb.disable': 'Disable',
  'admin.kb.testQuery': 'Test search',
  'admin.kb.runQuery': 'Search',
  'admin.kb.queryLoading': 'Searching…',
  'admin.kb.queryError': 'Search failed. Try again.',
  'admin.kb.queryResults': 'Knowledge-base search results',
  'admin.kb.relevance': 'Relevance',
  'admin.kb.noMatches': 'No matches found.',
  'admin.kb.processingError': 'Processing error',
  'admin.kb.reprocess': 'Reprocess',
  'admin.kb.confirmReprocess': 'Remove current indexed content and process the source again?',
  'admin.kb.errorProviderMissing': 'The embedding provider is not configured.',
  'admin.kb.errorModelMissing': 'Choose an embedding model.',
  'admin.kb.errorSourceEmpty': 'There is no source to process.',
  'admin.kb.errorSourceUnavailable': 'The source file is unavailable.',
  'admin.kb.errorUnsupportedFile': 'This file type cannot be processed.',
  'admin.kb.errorGeneric': 'Processing failed. Check the source settings and try again.',
  'admin.kb.save': 'Save',
  ...
  'admin.aiModels.enabled': 'Enabled',
  'admin.aiModels.disabled': 'Disabled',
  'admin.aiModels.maxTokens': 'Maximum response tokens',
  'admin.aiModels.temperature': 'Response temperature',
  'admin.aiModels.latency': 'Test response time',
  'admin.aiModels.testRequired': 'Test this model successfully before enabling it.',
  'admin.aiModels.confirmToggle': 'Change whether this model can be used?',
  'admin.aiModels.inUseAgents': 'This model is used by these agents: {agents}',
  ...
  'admin.jobs.type.contract_completion': 'Contract term completion',
  'admin.jobs.type.contract_activation': 'Contract activation',
  'admin.jobs.type.refund_retry': 'Wallet refund retries',
  ...
  'admin.invoices.ledger.title': 'Invoice ledger',
  'admin.invoices.ledger.description': 'Find invoices and review line items and payment activity.',
  'admin.invoices.ledger.state': 'Status',
  'admin.invoices.ledger.allStates': 'All statuses',
  'admin.invoices.ledger.searchId': 'Invoice ID (optional)',
  'admin.invoices.ledger.searchProfileId': 'Customer profile ID (optional)',
  'admin.invoices.ledger.searchOrderId': 'Order ID (optional)',
  'admin.invoices.ledger.search': 'Search',
  'admin.invoices.ledger.invalidId': 'Enter a valid invoice ID.',
  'admin.invoices.ledger.invalidProfileId': 'Enter a valid customer profile ID.',
  'admin.invoices.ledger.invalidOrderId': 'Enter a valid order ID.',
  'admin.invoices.ledger.forbidden': 'You do not have permission to view invoices.',
  'admin.invoices.ledger.error': 'Could not load invoices.',
  'admin.invoices.ledger.retry': 'Retry',
  'admin.invoices.ledger.loading': 'Loading invoices…',
  'admin.invoices.ledger.empty': 'No invoices found.',
  'admin.invoices.ledger.invoice': 'Invoice ID',
  'admin.invoices.ledger.type': 'Type',
  'admin.invoices.ledger.type.auto': 'Automatic',
  'admin.invoices.ledger.type.manual': 'Manual',
  'admin.invoices.ledger.order': 'Order ID',
  'admin.invoices.ledger.amount': 'Amount',
  'admin.invoices.ledger.paid': 'Paid',
  'admin.invoices.ledger.due': 'Due date',
  'admin.invoices.ledger.period': 'Electricity service period',
  'admin.invoices.ledger.unknown': 'Unknown',
  'admin.invoices.ledger.more': 'Load more',
  'admin.invoices.ledger.detail': 'Invoice details',
  'admin.invoices.ledger.close': 'Close',
  'admin.invoices.ledger.loadingDetail': 'Loading details…',
  'admin.invoices.ledger.detailError': 'Could not load details.',
  'admin.invoices.ledger.profile': 'Customer profile ID',
  ...
  'admin.invoices.ledger.unitPrice': 'Unit price',
  'admin.invoices.ledger.lineTotal': 'Line total',
  'admin.invoices.ledger.vat': 'VAT',
  'admin.invoices.ledger.vatTotal': 'Total VAT',
  'admin.invoices.ledger.activity': 'Payment activity',
  'admin.invoices.ledger.payment': 'Payment',
  'admin.invoices.ledger.receipt': 'Bank receipt',
  'admin.invoices.ledger.openReceipt': 'Open receipt scan',
  'admin.invoices.ledger.refund': 'Refund',
  'admin.invoices.ledger.noActivity': 'No payment activity yet.',
