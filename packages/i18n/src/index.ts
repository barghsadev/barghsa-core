...
export const fa: I18nDictionary = {
  ...
  "crm.profile.archive.warning": "پروفایل پنهان و سوابق آن حفظ می‌شود. سفارش یا قرارداد فعال، فاکتور پرداخت‌نشده، موجودی کیف پول، درخواست اصلاح هویت باز و محدودیت مالکیت ممکن است مانع بایگانی شوند. دلیل را وارد کنید.",
...
export const en: I18nDictionary = {
  ...
  "crm.profile.archive.warning": "This hides the profile while preserving its history. Active orders, contracts, unpaid invoices, wallet balances, open identity corrections and ownership constraints can block archiving. Enter the reason.",
