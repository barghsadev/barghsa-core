...
export const fa: I18nDictionary = {
  ...
  "admin.teams.deleteNote": "اعضا و کارهای قبلی حذف نمی‌شوند. تخصیص خودکار وابسته به این تیم به حالت دستی برمی‌گردد.",
  ...
  "admin.teams.expertiseHelp": "مهارت بر اساس برچسب تیم است و فرد واجد شرایط با کمترین کار باز انتخاب می‌شود. برچسب ticket یا verification_case کل نوع کار را پوشش می‌دهد؛ برچسب‌های جزئی support، order، invoice، identity، individual و legal هستند. نبود تیم یا عضو واجد شرایط به تخصیص دستی منجر می‌شود.",
  ...
  "tickets.conflict": "تیکت تغییر کرده یا نیاز به بازگشایی دارد. پیش از تلاش دوباره آن را تازه‌سازی کنید.",
  ...
  "team.acceptWarning": "با پذیرش، مالکیت به شما منتقل و نشست‌های هر دو مالک بسته می‌شود. باید دوباره وارد شوید.",
  ...
  "team.consent": "دسترسی فقط پس از پذیرش گیرنده آغاز می‌شود. دعوت‌نامه‌ها پس از هفت روز منقضی می‌شوند.",
  ...
  "team.transferWarning": "درخواست انتقال مالکیت برای {name} ارسال شود؟ تا زمان پذیرش، مالک باقی می‌مانید.",
  ...
  "team.confirm": "تأیید",
  "team.conflict": "این رکورد تغییر کرده یا منقضی شده است. پیش از تلاش دوباره، تیم را تازه‌سازی کنید.",
  ...
  'auth.forgotPassword.sent': 'اگر حساب کاربری با این اطلاعات وجود داشته باشد، کد تأیید برای شما ارسال خواهد شد',
  ...
  'settings.username.pairSent': 'کدهای تأیید برای نشانی فعلی و نشانی جدید در صف ارسال قرار گرفتند. هر دو کد را وارد کنید.',
  ...
  'invoices.details.receiptSubtitle': 'رسید واریز را بارگذاری کنید. تا تأیید واحد مالی، فاکتور تسویه نمی‌شود.',
  ...
  'invoices.details.receiptFileHint': 'PDF، JPG، PNG یا WebP. سقف ۱۰ مگابایت برای سند و ۲۰ مگابایت برای تصویر.',
  ...
  'invoices.details.receiptInvalidFile': 'یک فایل رسید معتبر (PDF یا تصویر) در سقف حجم مجاز انتخاب کنید.',
  ...
  "crm.corrections.description": "مدارک را برای بررسی کارشناس مجاز دیگری ارسال کنید. تغییر هویت تنها پس از تأیید اعمال می‌شود.",
  ...
  "crm.corrections.error": "عملیات انجام نشد. دسترسی، مدارک و اطلاعات ورودی را بررسی و دوباره تلاش کنید.",
  ...
  "crm.corrections.legacy": "نسخه ثابت مدارک در دسترس نیست. پیش از تأیید، درخواست را با مدارک تأییدشده دوباره ثبت کنید.",
  "crm.corrections.self": "کارشناس مجاز دیگری باید این درخواست را بررسی کند.",
  "crm.corrections.chooseProfile": "برای درخواست اصلاح هویت، پروفایل را در مدیریت مشتریان باز کنید.",
  ...
  'admin.walletLimit.conflict': 'سقف توسط ادمین دیگری به‌روز شده است. مقدار فعلی بارگذاری شد؛ دوباره ذخیره کنید.',
  ...
  "admin.approvals.description": "کارشناس مالی دیگری باید هر درخواست را تأیید یا رد کند. تأیید به‌تنهایی وجهی منتقل نمی‌کند؛ عملیات رسید یا پرداخت باید جداگانه تکمیل شود.",
  ...
  "admin.approvals.confirm": "تصمیم خود را برای این درخواست تأیید کنید. تأیید درخواست، پرداخت را اجرا نمی‌کند.",
  "admin.approvals.conflict": "این درخواست تغییر کرده یا قبلاً بررسی شده است. پنجره را ببندید و صف را تازه‌سازی کنید.",
  "admin.approvals.forbidden": "کاربر دیگری با دسترسی فعلی بررسی مالی باید این تصمیم را بگیرد.",
  "admin.approvals.saved": "تصمیم ثبت شد. رسید یا پرداخت همچنان باید در روند مربوط به خود تکمیل شود.",
  ...
  'admin.walletReceipts.description': 'رسید بانکی مشتری را بررسی کنید و آن را تأیید یا با دلیل رد کنید. تأیید، مبلغ را از طریق دفترکل به کیف پول واریز می‌کند و مشتری را مطلع می‌سازد. رد هرگز موجودی را افزایش نمی‌دهد و دلیل را برای مشتری ارسال می‌کند.',
  ...
  'admin.walletReceipts.reasonHint': 'این متن برای مشتری ارسال می‌شود و در سابقه حسابرسی ذخیره می‌گردد.',
  'admin.walletReceipts.saving': 'در حال ذخیره…',
  'admin.walletReceipts.approvalPending': 'رسید در انتظار تأیید کارشناس مالی دیگری است. هنوز مبلغی واریز نشده است.',
...
export const en: I18nDictionary = {
  ...
  "admin.teams.deleteNote": "Staff accounts and existing work are retained. Rules using this team fall back to manual assignment.",
  ...
  "admin.teams.expertiseHelp": "Expertise matches team tags, then picks the eligible member with the least open work. Use ticket or verification_case for a whole work type; narrower tags are support, order, invoice, identity, individual and legal. No available team or eligible member means manual assignment.",
  ...
  "team.acceptWarning": "Accepting transfers ownership to you and signs both owners out. You will need to sign in again.",
  ...
  "team.consent": "Access starts only after the recipient accepts. Invitations expire after seven days.",
  ...
  "team.removeWarning": "This member immediately loses access. Their historical activity is preserved.",
  "team.transfer": "Transfer ownership",
  "team.transferWarning": "Send an ownership request to {name}? You remain the owner until they accept.",
  ...
  'auth.forgotPassword.sent': 'If an account exists with this information, you will receive a verification code.',
  ...
  'settings.username.pairSent': 'Verification codes are queued for your current and new destinations. Enter both codes.',
  ...
  'invoices.details.receiptSubtitle': 'Upload a transfer receipt. The invoice stays unpaid until finance confirms it.',
  ...
  'invoices.details.receiptFileHint': 'PDF, JPG, PNG, or WebP. Max 10 MB for documents and 20 MB for images.',
  ...
  'invoices.details.receiptInvalidFile': 'Choose a valid receipt file (PDF or image) within the size limit.',
  ...
  "crm.corrections.description": "Submit evidence for a different authorized staff member to review. Identity changes take effect only after approval.",
  ...
  "crm.corrections.error": "Could not complete this operation. Check your access, evidence and input, then retry.",
  ...
  "crm.corrections.legacy": "Fixed evidence is unavailable. Resubmit the case with verified evidence before approval.",
  ...
  "crm.profile.archive.warning": "This hides the profile while preserving its history. Active orders, contracts, unpaid invoices, wallet balances and ownership constraints can block archiving. Enter the reason.",
    ...
    'admin.walletLimit.conflict': 'The limit was updated by another admin. The current value was reloaded; save again.',
  ...
  "admin.approvals.description": "A different finance reviewer must approve or reject each request. Approval alone does not transfer funds; complete the receipt or payment action separately.",
  ...
  "admin.approvals.confirm": "Confirm the decision for this request. Approval does not execute the payment.",
  "admin.approvals.conflict": "This request has changed or was already reviewed. Close this dialog and refresh the queue.",
  "admin.approvals.forbidden": "A different user with current financial review permission must make this decision.",
  "admin.approvals.saved": "Decision saved. Any receipt or payment must still be completed in its own workflow.",
  ...
  "admin.approvals.walletReceipts": "Open wallet receipts",
    ...
    'admin.walletReceipts.description': 'Review the customer bank receipt and confirm or reject it with a reason. Confirm credits the wallet through the ledger and notifies the customer. Reject never increases the balance and sends the reason to the customer.',
    ...
    'admin.walletReceipts.reasonHint': 'This text is sent to the customer and stored in the audit trail.',
    'admin.walletReceipts.saving': 'Saving…',
    'admin.walletReceipts.approvalPending': 'Waiting for a different finance reviewer. No funds have been credited yet.',
