...
export const fa: I18nDictionary = {
  ...
  'verification.banner.manualHelp': 'تأیید خودکار در دسترس نیست. برای پیگیری بررسی هویت یا اصلاح اطلاعات با پشتیبانی تماس بگیرید.',
  ...
  "crm.profile.archive.warning": "پروفایل پنهان و سوابق آن حفظ می‌شود. سفارش یا قرارداد فعال، فاکتور پرداخت‌نشده، موجودی کیف پول یا پرداخت در انتظار، درخواست اصلاح هویت باز و محدودیت مالکیت ممکن است مانع بایگانی شوند. دلیل را وارد کنید.",
  ...
  'crm.profile.contacts.explanation': 'این اطلاعات فقط برای تماس با این پروفایل است. اطلاعات ورود حساب از بخش تنظیمات حساب و پس از تأیید تغییر می‌کند.',
...
export const en: I18nDictionary = {
  ...
  'verification.banner.manualHelp': 'Automatic verification is unavailable. Contact support to follow up on identity review or correct your information.',
  ...
  "crm.profile.archive.warning": "This hides the profile while preserving its history. Active orders, contracts, unpaid invoices, wallet balances or pending payments, open identity corrections and ownership constraints can block archiving. Enter the reason.",
    ...
    'crm.profile.contacts.explanation': 'These contact details belong to this profile. Sign-in contacts are changed and verified in account settings.',
