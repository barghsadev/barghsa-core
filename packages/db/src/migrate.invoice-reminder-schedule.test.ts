 ...
 * create `invoice_reminder_schedule`. 0061 (unique index), 0062
 * (offset toggles), and 0063 (cancel on stop state) are journaled after
 * 0060 so migrate() also applies them; 0062 needs the `users` FK target.
 */
